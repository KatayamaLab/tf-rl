...
class A3CAgent:
    def __init__(
        ...
        #self.q_hat = PiVNetworkClass("q_hat", self.n_input, self.n_actions)
    ...
    def act_and_train(self):
        ...
        mu, sigma, v = self.pi_v_network()
        a_t = np.random.normal(mu, sigma, self.a_dim)
